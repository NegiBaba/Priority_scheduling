...
cout << endl << "\tEnter the number of processes: " << endl;
cout << "\t";
cin >> number;
CLR;

cout << endl <<  "\tEnter the priority of processes: " << endl;
...
cout << endl << "\tEnter the arrival time: " << endl;
for(int i = 0; i < number; i++)
{
	cout << "\t";
	cin >> aTime[i];
...
cout << endl << "\tEnter the burst time: " << endl;
for(int i = 0; i < number; i++)
{
	cout << "\t";
	cin >> bursttime[i];
